...
import { NotaBeliToPrint } from "@/Components/Print/NotaBeli";
...
export default function BeliShowPage(props) {
    const [isLoading, setIsLoading] = useState(false);
    const componentRef = useRef();
    return (
        <>
            {isLoading && <Loading />}
            <MasterAdmin title={"Show Pembelian"}>
                <div className="hidden">
                    <NotaBeliToPrint ref={componentRef} data={props.data} />
                </div>
                <div className="card bg-base-100 mb-2">
                    <div className="card-body">
                        ...
                        <div className="flex flex-row items-center gap-1">
                            ...
                            />
                            <Link
                                href={route("transaksi.pembelian.beli")}
